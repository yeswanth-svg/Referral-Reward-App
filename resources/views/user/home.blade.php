                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-8" id="small-screen-banner">
                            <div class="px-3">
                                ...
                                <p class="fs-16 lh-base text-white">Refer Your Friends & Family to Earn Commission.
                                    Share your referral code with others and get a 5% commission on every order they
                                    make! Share your referral code <span
                        ...
                        <div class="col-sm-4" id="small-screen-banner">
                            <div class="px-3">
                                <img src="{{asset('user/assets/images/user-illustarator-1.png')}}" class="img-fluid"
                                    alt="">
                            </div>
                        </div>
                    </div>
