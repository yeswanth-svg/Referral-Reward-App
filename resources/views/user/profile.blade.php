                            ...
                            <div class="row">
                                        ...
                                        <div class="form-group col-12">
                                            <div class="avatar-upload">
                                                <label for="profile_img"
                                                    style="cursor: pointer; display: block;margin-left: auto;margin-right: auto;width: 200px; height: 200px;">
                                                    <img alt="image" class="img-fluid" id="dpShowLabel"
                                                        style="cursor: pointer; display: block;margin-left: auto;margin-right: auto;width: 200px; height: 200px;"
                                                        src="{{ asset('uploads/profile/' . (Auth::user()->image ? Auth::user()->image : 'avatar.jpg')) }}">
                                                </label>
                                                <input type="file" name="image" id="profile_img" class="visually-hidden"
                                                    accept="image/*" hidden onchange="imageName(this)">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-8">
                                    <div class="row mt-4">
                                        ...
                                        <div class="form-group col-12 mt-2">
                                            <label for="email">Area / Village</label>
                                        ...
                                        <div class="form-group col-12 mt-2">
                                            ...
                                            <input type="number" class="form-control" id="aadhar_number"
                                                name="aadhar_number" disabled required
