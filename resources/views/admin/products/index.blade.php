        ...
        <div class="ibox">
            <div class="ibox-title d-flex justify-content-between align-items-center">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                    style="margin-right: -66px !important;" data-bs-target="#addRecord">
                                                        ...
                                                        <tr class="gradeX" style="cursor: pointer;">
                                                            ...
                                                            <td class="">
                                                                <button type="button" class="btn btn-dark btn-sm btn-block" id="edit_button"
                                                                    data-bs-toggle="modal" data-bs-target="#editRecord" data-id="{{$product->id}}"
                                                                    data-name="{{$product->name}}"
                                                                    data-short_description="{{$product->short_description}}"
                                                                    data-description="{{$product->description}}" data-price="{{$product->price}}"
                                                                    data-image="{{$product->image}}" data-status="{{$product->status}}">
                                                                    <i class="fa fa-edit"> </i> View/Edit
                                                                </button>
                                                                <button class="btn btn-danger btn-sm btn-block delete-button"
                                                                    onclick="deletePrompt({{$product->id}})" data-id="{{$product->id}}">
                                                                    <i class="fa fa-trash"> </i> Delete
                                                                </button>
                                                                <form action="{{ route('admin.products-delete') }}" id="delForm-{{$product->id}}"
                                                                    method="post">
                                                                    @csrf
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.products-store') }}" method="post" id="addRecordForm"
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            <div class="row mb-3">
                                <div class="col">
                                    <h4><label for="exampleInputEmail1" class="form-label">Service Name</label></h4>
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    <h4><label for="exampleInputEmail1" class="form-label">Short Description</label>
                                    </h4>
                                    <textarea rows="5" class="form-control" name="short_description"
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="addRecordForm" class="btn btn-primary">Add Service</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="editRecord" tabindex="-1" aria-labelledby="editRecord" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.products-update') }}" method="post" id="editRecordForm"
                    enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col">
                            ...
                            <div class="row mb-2">
                                <div class="col-12">
                                    ...
                                    <textarea rows="5" class="form-control" name="short_description"
                                        id="edit_short_description" required></textarea>
                                </div>
                            </div>
                            <div class="row mb-2">
                                <div class="col-12">
                                    <h4><label for="exampleInputEmail1" class="form-label">Long Description</label></h4>
                                    <textarea rows="5" class="form-control" name="description" id="edit_description"
                                        required></textarea>
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-4">
                                    <h4><label for="exampleInputEmail1" class="form-label">Active Status</label>
                                    </h4>
                                    <div class="switch mt-3">
                                        <div class="onoffswitch">
                                            <input type="checkbox" class="onoffswitch-checkbox" id="status_box"
                                                name="status">
                                ...
                                <div class="col-4">
                                    ...
                                    @if (isset($product->image))
                                        <img src="{{ asset('uploads/products/' . $product->image) }}" alt="Product Image"
                                            class="img-fluid " id="edit_product_image">
                                    @endif
...
<script>
    $(document).ready(function () {
        ...
        $('#editRecord').on('show.bs.modal', function (event) {
            ...
            $('#edit_product_image').attr('src', "{{ asset('uploads/products') }}/" + image);
