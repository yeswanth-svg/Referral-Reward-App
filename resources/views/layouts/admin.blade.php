                ...
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            <img alt="image" class="rounded-circle" style="width: 48px; height: 48px;"
                                src="{{ asset('uploads/profile/' . (Auth::guard('admin')->user()->image ? Auth::guard('admin')->user()->image : 'avatar.jpg')) }}" />
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li>
                                    ...
                                    <form action="{{ route('admin.logout') }}" id="logout-form" class="d-none"
                                        method="POST">
                                        @csrf
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li>
                            <div class="mr-4" style="cursor: pointer; margin-right: 20px; text-decoration:underline;"
